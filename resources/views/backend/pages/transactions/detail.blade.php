            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <h6 class="txt-dark">Order {{ $transaction->code_transaction}}</h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <address class="mb-15">
                                    <span class="address-head mb-5">{{ $transaction->user->name}}</span>
                        ...
                        <div class="invoice-bill-table">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($transaction->details as $list)
                                        <tr>
                                            <td>{{ $list->book_id }}</td>
                                        ...
                                        <tr class="txt-dark">
                                            ...
                                            <td></td>
                                            <td>Kurir</td>
                                            <td>@currency( $transaction->cost)</td>
                                        </tr>
                                        <tr class="txt-dark">
                                            <td></td>
                                            <td></td>
                                            <td>Total</td>
                                            <td>@currency( $transaction->transaction_total + $transaction->cost)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
