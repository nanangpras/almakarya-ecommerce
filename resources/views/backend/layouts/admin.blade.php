...
<head>
    ...
    <title>Admin | Jitus Teman Pintarmu</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="frontend/img/frontend/img/frontend/img/favicon2.ico">
    <link rel="icon" href="frontend/img/favicon2.ico" type="image/x-icon">
