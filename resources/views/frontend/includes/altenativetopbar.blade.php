                                    ...
                                    <div class="dropdown dropdown-cart">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <div class="total_drop">
                                                <div class="clearfix"><strong>Total</strong><span>Rp 200.000</span></div>
                                                <a href="{{ route('list-cart')}}" class="btn_1 outline">View Cart</a><a href="{{ route('checkout')}}" class="btn_1">Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /dropdown-cart-->
